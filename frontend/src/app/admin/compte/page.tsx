        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <span className="text-xs bg-purple-50 text-purple-700 px-2 py-0.5 rounded mt-1 inline-block">
                Administrateur
              </span>
            </div>
          </div>
          <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-4">
            <div>
              ...
              <input {...profileForm.register('name')} className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-[#4338CA] transition-colors" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Téléphone</label>
              <input {...profileForm.register('phone')} placeholder="+221 77 000 00 00" className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-[#4338CA] transition-colors" />
            </div>
            <div>
            ...
            {([
              ...
              <div key={name}>
                ...
                <input {...pwdForm.register(name)} type="password" placeholder="••••••••"
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-[#4338CA] transition-colors" />
